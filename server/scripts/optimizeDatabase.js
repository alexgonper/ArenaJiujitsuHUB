...
// Import models com paths corretos
...
const createOptimizedIndexes = async () => {
    try {
        ...
        await Franchise.collection.createIndex({ location: '2dsphere' }); // Para queries geográficas
...
const analyzeQueryPerformance = async () => {
    ...
    try {
        // Exemplo: Verificar query plan para busca de students
        const explain = await Student.find({ franchiseId: '507f1f77bcf86cd799439011' })
...
module.exports = { createOptimizedIndexes, analyzeQueryPerformance };
